...
class User
{
     ...
     */
    public function getDatecommence(): ?\DateTime
    {
     ...
     */
    public function setDatecommence(?\DateTime $datecommence): void
    {
     ...
     */
    public function setMatriculefiscale(?int $matriculefiscale): void
    {
    ...
    {
        return $this->getIduser().' | '.$this->getNomuser();
    }
