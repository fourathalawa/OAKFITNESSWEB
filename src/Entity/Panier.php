 ...
 * Panier
 *
 * @ORM\Table(name="panier", indexes={@ORM\Index(name="fkProduit", columns={"id_produit"}), @ORM\Index(name="FK_24CC0DF2E173B1B8", columns={"id_client"}), @ORM\Index(name="id", columns={"id"}), @ORM\Index(name="fkCom", columns={"id_commande"})})
 * @ORM\Entity
 */
class Panier
{
